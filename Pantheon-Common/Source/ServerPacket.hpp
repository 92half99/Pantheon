...
enum class PacketType : uint16_t
{
	...
	// 
	// [Server->Client]
	// 1. Username - UTF-8 serialized as per Utopia
	// 2. Message - UTF-8 string serialized as per Utopia
	// [Client->Server]
	...
	// 2. Utopia serialized UTF-8 string with requested username
	// [Server->Client]
	...
	// 
	// [Server->Client]
	// Contains serialized std::vector (as per Utopia serialization) of ClientInfo structs (color + username)
	...
	// 2. Requested username (Utopia serialized UTF-8 string)
	ClientConnect = 5,
	...
	// 
	// [Server->Client]
	// 1. Existing username (Utopia serialized UTF-8 string)
	// 2. New color for user (32-bit int, RGB)
	// 3. New username (Utopia serialized UTF-8 string)
	// [Client->Server]
	// 1. Requested new color (32-bit int, RGB)
	// 2. Requested new username (Utopia serialized UTF-8 string)
	ClientUpdate = 6,
	...
	// 1. Utopia serialized UTF-8 string with username
	// [Client->Server]
